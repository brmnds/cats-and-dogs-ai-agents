...
*This document provides an overview of the project's technical architecture and serves as context for AI assistants and developers working on the project.*
...
*Note: This document serves as a living guide and should be updated as the project architecture evolves. Sections marked [TO BE DEFINED] should be filled in as architectural decisions are made.*